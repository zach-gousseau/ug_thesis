...
from model_1e.crossover import *
from model_1e.mutation import *
from model_1e.sampling import *
from model_1e.problem import *
...
class BasicGA(Algorithm):
    ...
    def plot_all_timespace(self):
        for i in range(len(self.result.X)):
            self.plot_timespace(X=self.result.X[i], fn=f'plots/timespace/s{i}.jpg')
    ...
    def plot_timespace(self, X=None, idx=None, fn=''):
        ...
        if fn == '':
            fig.savefig('model_base/plots/demand.jpg')
        else:
    ...
    def plot_convergence(self):
        ...
        fig.savefig('model_base/plots/convergence.jpg')
        plt.close(fig)
